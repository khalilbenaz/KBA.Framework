...
namespace KBA.Framework.Api.IntegrationTests.Controllers;
        ...
        _factory = factory.WithWebHostBuilder(builder =>
        {
            builder.ConfigureServices(services =>
            {
                ...
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<KBADbContext>));
                ...
                services.AddDbContext<KBADbContext>(options =>
                {
                ...
                var db = scope.ServiceProvider.GetRequiredService<KBADbContext>();
